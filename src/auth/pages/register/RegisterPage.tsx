...
import { registerAction } from "@/auth/actions/resgister.action"
...
export const RegisterPage = () => {
    ...
    const handleRegister = async (event: React.SubmitEvent<HTMLFormElement>) => {
        ...
        toast.error('Se produjo un error', {
            description: 'Imposible generar este nuevo usuario',
            duration: 10_000,
    ...
    return (
        <div className={"flex flex-col gap-6"}>
                    ...
                    <form className="p-6 md:p-8" onSubmit={(event) => handleRegister(event)}>
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                                <span className="relative z-10 bg-background px-2 text-muted-foreground">O entra con </span>
                            </div>
            ...
            <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
                Haciendo clic, estarás de acuerdo con nuestros  <a href="#">Términos y condiciones</a> y <a href="#">Políticas de uso</a>.
            </div>
        </div>
    )
}
